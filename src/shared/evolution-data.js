...
export const EVOLUTION_DATA = {
    ...
    10: { evolvesTo: 11, candyCost: 12, name: "Metapod", baseCandyId: 10 },   // Caterpie → Metapod
    11: { evolvesTo: 12, candyCost: 50, name: "Butterfree", baseCandyId: 10 }, // Metapod → Butterfree
    
    // Weedle evolution line
    13: { evolvesTo: 14, candyCost: 12, name: "Kakuna", baseCandyId: 13 },    // Weedle → Kakuna
    14: { evolvesTo: 15, candyCost: 50, name: "Beedrill", baseCandyId: 13 },  // Kakuna → Beedrill
    
    // Pidgey evolution line
    16: { evolvesTo: 17, candyCost: 12, name: "Pidgeotto", baseCandyId: 16 }, // Pidgey → Pidgeotto
    17: { evolvesTo: 18, candyCost: 50, name: "Pidgeot", baseCandyId: 16 },   // Pidgeotto → Pidgeot
    
    // Rattata evolution line
    19: { evolvesTo: 20, candyCost: 25, name: "Raticate", baseCandyId: 19 },  // Rattata → Raticate
    
    // Spearow evolution line
    21: { evolvesTo: 22, candyCost: 50, name: "Fearow", baseCandyId: 21 },    // Spearow → Fearow
    
    // Ekans evolution line
    23: { evolvesTo: 24, candyCost: 50, name: "Arbok", baseCandyId: 23 },     // Ekans → Arbok
    
    // Pikachu evolution line
    25: { evolvesTo: 26, candyCost: 50, name: "Raichu", baseCandyId: 25 }, // Pikachu → Raichu
    
    // Sandshrew evolution line
    27: { evolvesTo: 28, candyCost: 50, name: "Sandslash", baseCandyId: 27 }, // Sandshrew → Sandslash
    
    // Nidoran♀ evolution line
    29: { evolvesTo: 30, candyCost: 25, name: "Nidorina", baseCandyId: 29 },  // Nidoran♀ → Nidorina
    30: { evolvesTo: 31, candyCost: 100, name: "Nidoqueen", baseCandyId: 29 }, // Nidorina → Nidoqueen
    
    // Nidoran♂ evolution line
    32: { evolvesTo: 33, candyCost: 25, name: "Nidorino", baseCandyId: 32 },  // Nidoran♂ → Nidorino
    33: { evolvesTo: 34, candyCost: 100, name: "Nidoking", baseCandyId: 32 }, // Nidorino → Nidoking
    
    // Clefairy evolution line
    35: { evolvesTo: 36, candyCost: 50, name: "Clefable", baseCandyId: 35 }, // Clefairy → Clefable
    
    // Vulpix evolution line
    37: { evolvesTo: 38, candyCost: 50, name: "Ninetales", baseCandyId: 37 }, // Vulpix → Ninetales
    
    // Jigglypuff evolution line
    39: { evolvesTo: 40, candyCost: 50, name: "Wigglytuff", baseCandyId: 39 }, // Jigglypuff → Wigglytuff
    
    // Zubat evolution line
    41: { evolvesTo: 42, candyCost: 25, name: "Golbat", baseCandyId: 41 },    // Zubat → Golbat
    
    // Oddish evolution line
    43: { evolvesTo: 44, candyCost: 25, name: "Gloom", baseCandyId: 43 },     // Oddish → Gloom
    44: { evolvesTo: 45, candyCost: 100, name: "Vileplume", baseCandyId: 43 }, // Gloom → Vileplume
    
    // Paras evolution line
    46: { evolvesTo: 47, candyCost: 50, name: "Parasect", baseCandyId: 46 },  // Paras → Parasect
    
    // Venonat evolution line
    48: { evolvesTo: 49, candyCost: 50, name: "Venomoth", baseCandyId: 48 },  // Venonat → Venomoth
    
    // Diglett evolution line
    50: { evolvesTo: 51, candyCost: 50, name: "Dugtrio", baseCandyId: 50 },   // Diglett → Dugtrio
    
    // Meowth evolution line
    52: { evolvesTo: 53, candyCost: 50, name: "Persian", baseCandyId: 52 },   // Meowth → Persian
    
    // Psyduck evolution line
    54: { evolvesTo: 55, candyCost: 50, name: "Golduck", baseCandyId: 54 },   // Psyduck → Golduck
    
    // Mankey evolution line
    56: { evolvesTo: 57, candyCost: 50, name: "Primeape", baseCandyId: 56 },  // Mankey → Primeape
    
    // Growlithe evolution line
    58: { evolvesTo: 59, candyCost: 50, name: "Arcanine", baseCandyId: 58 }, // Growlithe → Arcanine
    
    // Poliwag evolution line
    60: { evolvesTo: 61, candyCost: 25, name: "Poliwhirl", baseCandyId: 60 }, // Poliwag → Poliwhirl
    61: { evolvesTo: 62, candyCost: 100, name: "Poliwrath", baseCandyId: 60 }, // Poliwhirl → Poliwrath
    
    // Abra evolution line
    63: { evolvesTo: 64, candyCost: 25, name: "Kadabra", baseCandyId: 63 },   // Abra → Kadabra
    64: { evolvesTo: 65, candyCost: 100, name: "Alakazam", baseCandyId: 63 }, // Kadabra → Alakazam
    
    // Machop evolution line
    66: { evolvesTo: 67, candyCost: 25, name: "Machoke", baseCandyId: 66 },   // Machop → Machoke
    67: { evolvesTo: 68, candyCost: 100, name: "Machamp", baseCandyId: 66 }, // Machoke → Machamp
    
    // Bellsprout evolution line
    69: { evolvesTo: 70, candyCost: 25, name: "Weepinbell", baseCandyId: 69 }, // Bellsprout → Weepinbell
    70: { evolvesTo: 71, candyCost: 100, name: "Victreebel", baseCandyId: 69 }, // Weepinbell → Victreebel
    
    // Tentacool evolution line
    72: { evolvesTo: 73, candyCost: 50, name: "Tentacruel", baseCandyId: 72 }, // Tentacool → Tentacruel
    
    // Geodude evolution line
    74: { evolvesTo: 75, candyCost: 25, name: "Graveler", baseCandyId: 74 },  // Geodude → Graveler
    75: { evolvesTo: 76, candyCost: 100, name: "Golem", baseCandyId: 74 }, // Graveler → Golem
    
    // Ponyta evolution line
    77: { evolvesTo: 78, candyCost: 50, name: "Rapidash", baseCandyId: 77 },  // Ponyta → Rapidash
    
    // Slowpoke evolution line
    79: { evolvesTo: 80, candyCost: 50, name: "Slowbro", baseCandyId: 79 },   // Slowpoke → Slowbro
    
    // Magnemite evolution line
    81: { evolvesTo: 82, candyCost: 50, name: "Magneton", baseCandyId: 81 },  // Magnemite → Magneton
    
    // Doduo evolution line
    84: { evolvesTo: 85, candyCost: 50, name: "Dodrio", baseCandyId: 84 },    // Doduo → Dodrio
    
    // Seel evolution line
    86: { evolvesTo: 87, candyCost: 50, name: "Dewgong", baseCandyId: 86 },   // Seel → Dewgong
    
    // Grimer evolution line
    88: { evolvesTo: 89, candyCost: 50, name: "Muk", baseCandyId: 88 },       // Grimer → Muk
    
    // Shellder evolution line
    90: { evolvesTo: 91, candyCost: 50, name: "Cloyster", baseCandyId: 90 }, // Shellder → Cloyster
    
    // Gastly evolution line
    92: { evolvesTo: 93, candyCost: 25, name: "Haunter", baseCandyId: 92 },   // Gastly → Haunter
    93: { evolvesTo: 94, candyCost: 100, name: "Gengar", baseCandyId: 92 }, // Haunter → Gengar
    
    // Drowzee evolution line
    96: { evolvesTo: 97, candyCost: 50, name: "Hypno", baseCandyId: 96 },     // Drowzee → Hypno
    
    // Krabby evolution line
    98: { evolvesTo: 99, candyCost: 50, name: "Kingler", baseCandyId: 98 },   // Krabby → Kingler
    
    // Voltorb evolution line
    100: { evolvesTo: 101, candyCost: 50, name: "Electrode", baseCandyId: 100 }, // Voltorb → Electrode
    
    // Exeggcute evolution line
    102: { evolvesTo: 103, candyCost: 50, name: "Exeggutor", baseCandyId: 102 }, // Exeggcute → Exeggutor
    
    // Cubone evolution line
    104: { evolvesTo: 105, candyCost: 50, name: "Marowak", baseCandyId: 104 }, // Cubone → Marowak
    
    // Koffing evolution line
    109: { evolvesTo: 110, candyCost: 50, name: "Weezing", baseCandyId: 109 }, // Koffing → Weezing
    
    // Rhyhorn evolution line
    111: { evolvesTo: 112, candyCost: 50, name: "Rhydon", baseCandyId: 111 }, // Rhyhorn → Rhydon
    
    // Horsea evolution line
    116: { evolvesTo: 117, candyCost: 50, name: "Seadra", baseCandyId: 116 }, // Horsea → Seadra
    
    // Goldeen evolution line
    118: { evolvesTo: 119, candyCost: 50, name: "Seaking", baseCandyId: 118 }, // Goldeen → Seaking
    
    // Staryu evolution line
    120: { evolvesTo: 121, candyCost: 50, name: "Starmie", baseCandyId: 120 }, // Staryu → Starmie
    
    // Magikarp evolution line
    129: { evolvesTo: 130, candyCost: 400, name: "Gyarados", baseCandyId: 129 }, // Magikarp → Gyarados
    ...
    138: { evolvesTo: 139, candyCost: 50, name: "Omastar", baseCandyId: 138 }, // Omanyte → Omastar
    
    // Kabuto evolution line
    140: { evolvesTo: 141, candyCost: 50, name: "Kabutops", baseCandyId: 140 }, // Kabuto → Kabutops
    
    // Dratini evolution line
    147: { evolvesTo: 148, candyCost: 25, name: "Dragonair", baseCandyId: 147 }, // Dratini → Dragonair
    148: { evolvesTo: 149, candyCost: 100, name: "Dragonite", baseCandyId: 147 } // Dragonair → Dragonite
...
export const CANDY_FAMILY_MAP = {
    ...
    133: 133, 134: 133, 135: 133, 136: 133,
 ...
 * Complete list for all Gen 1 Pokemon (1-151).
 */
