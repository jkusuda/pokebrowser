// Pokéball catch animation primitives.
//
// The catch sequence combines CSS keyframe animations (for arcs, shakes,
// and scale pulses) with spritesheet frame stepping (for the ball's
// spin/flash/shake/success states). Keep both timing systems in one place
// so tweaking feel doesn't require hopping between files.
